...
@Component("getConfigDetailsForAssetInstanceCustomTab")
public class GetConfigDetailsForAssetInstanceCustomTabStrategy extends OrientDBBaseStrategy
    implements IGetConfigDetailsForAssetInstanceCustomTabStrategy {
      ...
      throws Exception
  {
    ...
    return execute(GET_CONFIG_DETAILS_FOR_ASSET_INSTANCE_CUSTOM_TAB, model,
