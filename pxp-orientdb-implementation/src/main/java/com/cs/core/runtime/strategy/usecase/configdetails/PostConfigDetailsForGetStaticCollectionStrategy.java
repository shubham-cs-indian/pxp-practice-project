...
@Component("postConfigDetailsForGetStaticCollectionStrategy")
public class PostConfigDetailsForGetStaticCollectionStrategy extends OrientDBBaseStrategy
    implements IGetPostConfigDetailsStrategy {
  
  public static final String useCase = "PostConfigDetailsForGetStaticCollection";
