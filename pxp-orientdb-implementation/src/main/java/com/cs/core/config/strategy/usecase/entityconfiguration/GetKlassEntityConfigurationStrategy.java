...
@Component
public class GetKlassEntityConfigurationStrategy extends OrientDBBaseStrategy
      ...
      throws Exception
  {
    ...
    return execute(GET_KLASS_ENTITY_CONFIGURATION, model, GetEntityConfigurationResponseModel.class);
  }
