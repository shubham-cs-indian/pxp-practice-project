...
@Component
public class OrientDBDeleteRelationshipsStrategy extends OrientDBBaseStrategy
    implements IDeleteRelationshipStrategy {
  
  public static final String useCase = "DeleteRelationship";
