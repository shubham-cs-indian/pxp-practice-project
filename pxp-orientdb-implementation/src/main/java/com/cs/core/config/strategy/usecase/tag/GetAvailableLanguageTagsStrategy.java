...
@Component
public class GetAvailableLanguageTagsStrategy extends OrientDBBaseStrategy
    implements IGetAvailableLanguageTagsStrategy {
  
  @Override
  public IListModel<IGetEntityModel> execute(IIdParameterModel model) throws Exception
  {
    return execute(GET_AVAILABLE_LANGUAGE_TAGS, model,
