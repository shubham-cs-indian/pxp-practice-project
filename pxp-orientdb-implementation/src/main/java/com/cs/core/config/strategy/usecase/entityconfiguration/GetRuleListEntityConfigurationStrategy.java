...
@Component
public class GetRuleListEntityConfigurationStrategy extends OrientDBBaseStrategy
  ...
  public IGetEntityConfigurationResponseModel execute(IGetEntityConfigurationRequestModel model)
      throws Exception
  {
    return execute(GET_RULELIST_ENTITY_CONFIGURATION, model, GetEntityConfigurationResponseModel.class);
  }
