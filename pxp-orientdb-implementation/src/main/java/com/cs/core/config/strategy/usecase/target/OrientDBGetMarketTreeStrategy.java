...
@Component("getMarketTreeStrategy")
public class OrientDBGetMarketTreeStrategy extends OrientDBBaseStrategy
    implements IGetKlassTreeStrategy {
  
  public static final String useCase = "GetMarketTree";
