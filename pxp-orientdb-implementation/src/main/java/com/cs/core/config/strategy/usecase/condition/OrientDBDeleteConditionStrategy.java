...
@Component
public class OrientDBDeleteConditionStrategy extends OrientDBBaseStrategy
    implements IDeleteConditionStrategy {
  
  public static final String useCase = "DeleteConditions";
