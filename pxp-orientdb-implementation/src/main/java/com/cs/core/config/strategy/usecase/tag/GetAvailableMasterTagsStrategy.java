...
@Component
public class GetAvailableMasterTagsStrategy extends OrientDBBaseStrategy
    implements IGetAvailableMasterTagsStrategy {
  
  @Override
  public IListModel<IGetEntityModel> execute(IIdParameterModel model) throws Exception
  {
    return execute(GET_AVAILABLE_MASTER_TAGS, model, new TypeReference<ListModel<GetEntityModel>>()
    {
