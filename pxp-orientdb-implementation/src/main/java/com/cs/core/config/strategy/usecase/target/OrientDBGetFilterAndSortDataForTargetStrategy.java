...
@Component("getFilterAndSortDataForTargetStrategy")
public class OrientDBGetFilterAndSortDataForTargetStrategy extends OrientDBBaseStrategy
  ...
  public IGetFilterInformationModel execute(IGetFilterAndSortDataRequestModel model)
      throws Exception
  {
    return execute(GET_FILTER_AND_SORT_DATA_FOR_TARGET, model, GetFilterInformationModel.class);
  }
}
