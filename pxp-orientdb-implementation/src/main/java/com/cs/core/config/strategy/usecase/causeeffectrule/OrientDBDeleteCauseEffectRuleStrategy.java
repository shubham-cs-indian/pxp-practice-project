...
@Component
public class OrientDBDeleteCauseEffectRuleStrategy extends OrientDBBaseStrategy
    implements IDeleteCauseEffectRuleStrategy {
  
  public static final String useCase = "DeleteCauseEffectRules";
  ...
  public IBulkDeleteReturnModel execute(IIdsListParameterModel model) throws Exception
  {
    ...
    return super.execute(useCase, requestMap, BulkDeleteReturnModel.class);
  }
}
