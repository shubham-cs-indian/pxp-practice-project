...
@Component
public class GetTabEntityConfigurationStrategy extends OrientDBBaseStrategy
      ...
      throws Exception
  {
    ...
    return execute(GET_TAB_ENTITY_CONFIGURATION, model, GetEntityConfigurationResponseModel.class);
  }
