...
@Component("getTextAssetTreeStrategy")
public class OrientDBGetTextAssetTreeStrategy extends OrientDBBaseStrategy
    implements IGetKlassTreeStrategy {
  
  public static final String useCase = "GetTextAssetTree";
