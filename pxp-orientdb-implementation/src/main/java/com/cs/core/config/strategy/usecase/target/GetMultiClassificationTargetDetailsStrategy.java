...
@Component("getMultiClassificationTargetDetailsStrategy")
public class GetMultiClassificationTargetDetailsStrategy extends OrientDBBaseStrategy
      ...
      throws Exception
  {
    ...
    return execute(GET_MULTICLASSIFICATION_TARGET_DETAILS, map,
