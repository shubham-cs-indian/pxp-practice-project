...
@Component
public class GetPartnerEntityConfigurationStrategy extends OrientDBBaseStrategy
implements IGetEntityConfigurationStrategy {
	...
	public IGetEntityConfigurationResponseModel execute(IGetEntityConfigurationRequestModel model) throws Exception {
		return execute(GET_PARTNER_ENTITY_CONFIGURATION, model, GetEntityConfigurationResponseModel.class);
	}
