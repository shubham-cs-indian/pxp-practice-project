...
@Component("getMultiClassificationArticleDetailsStrategy")
public class GetMultiClassificationArticleDetailsStrategy extends OrientDBBaseStrategy
      ...
      throws Exception
  {
    ...
    return execute(GET_MULTICLASSIFICATION_ARTICLE_DETAILS, map,
