...
@Component
public class GetUserEntityConfigurationStrategy extends OrientDBBaseStrategy
implements IGetEntityConfigurationStrategy {
	...
	public IGetEntityConfigurationResponseModel execute(IGetEntityConfigurationRequestModel model) throws Exception {
		return execute(GET_USER_ENTITY_CONFIGURATION, model, GetEntityConfigurationResponseModel.class);
	}
