...
@Service
public abstract class AbstractGetInstancesForSmartDocumentService extends
    AbstractRuntimeService<IGetEntityForSmartDocumentRequestModel, IListModel<ISmartDocumentKlassInstanceDataModel>> {
      ...
      IGetEntityForSmartDocumentRequestModel dataModel) throws Exception
  {
    ...
    IGetConfigDetailsToFetchDataForSmartDocumentResponseModel configDetails = getConfigDetails(
        dataModel);
    
    IGetInstancesForSmartDocumentResponseModel response = getInstancesForSmartDocument(dataModel,
        configDetails);
      ...
      IGetInstancesForSmartDocumentResponseModel response) throws Exception
  {
    ...
    String languageCode = configDetails.getPresetConfigDetails()
        .getLanguageCode();
    String presetId = configDetails.getPresetConfigDetails()
        .getId();
    for (IBaseEntityDTO baseEntityDTO : response.getKlassInstances()) {
      ...
      baseEntityDTO = SmartDocumentUtils.loadAttributesAndTagsPropertyForSmartDocument(
          baseEntityDAO, configDetailsForInstance, smartDocumentPreset);
      ISmartDocumentKlassInstanceDataModel smartDocumentKlassInstance = SmartDocumentUtils
          .getSmartDocumentKlassInstance(baseEntityDTO, imageAttributeInstanceMap,
              configDetailsForInstance, getUserCodeLabelMap());
      processSmartDocumentModel(smartDocumentKlassInstance, baseEntityDTO, configDetailsForInstance,
          response);
