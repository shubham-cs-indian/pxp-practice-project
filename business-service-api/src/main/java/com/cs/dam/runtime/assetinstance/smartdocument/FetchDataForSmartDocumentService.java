...
@Service("fetchDataForSmartDocumentService")
@SuppressWarnings("unchecked")
public class FetchDataForSmartDocumentService implements IFetchDataForSmartDocumentService {
  
  /*@Autowired
  protected IGetInstanceForSmartDocument              getInstanceForSmartDocument;*/
  
  @Autowired
  protected IGetVariantInstancesForSmartDocumentService      getVariantInstancesForSmartDocument;
  
  @Autowired
  protected IGetRelationshipInstancesForSmartDocumentService getRelationshipInstancesForSmartDocument;
