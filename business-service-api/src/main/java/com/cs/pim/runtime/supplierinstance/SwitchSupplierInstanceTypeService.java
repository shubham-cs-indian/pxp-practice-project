...
@Service
public class SwitchSupplierInstanceTypeService
    extends NewSwitchInstanceTypeService<IKlassInstanceTypeSwitchModel, IGetKlassInstanceModel>
    implements ISwitchSupplierInstanceTypeService {
  
  @Autowired
  IGetConifgDetailsForTypeSwitchOfInstanceStrategy getConifgDetailsForTypeSwitchOfInstanceStrategy;
      ...
      throws Exception
  {
    try {
      ...
      throw new UserNotHaveCreatePermissionForSupplier(e);
    }
