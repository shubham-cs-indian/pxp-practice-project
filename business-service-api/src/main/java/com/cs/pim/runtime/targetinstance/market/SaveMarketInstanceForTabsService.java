...
@Service
public class SaveMarketInstanceForTabsService extends AbstractSaveInstanceForTabs<IMarketInstanceSaveModel, IGetKlassInstanceModel>
    implements ISaveMarketInstanceForTabsService {
