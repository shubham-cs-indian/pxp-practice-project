...
public class ElasticSyncUtil {
  ...
  public static void fillColorViolations(Map<String, Object> instance, ILocaleCatalogDAO localeCatalogDAO, Long baseEntityIID) throws RDBMSException
  {
    ...
    List<String> redViolations = violationVSLocalesMap.get(CommonConstants.RED_VOILATION_FILTER);
    List<String> orangeViolations = violationVSLocalesMap.get(CommonConstants.ORANGE_VOILATION_FILTER);
    List<String> yellowViolations = violationVSLocalesMap.get(CommonConstants.YELLOW_VOILATION_FILTER);
