...
public class Constants {
  ...
  // TODO: additional constant added for switch type use case, should verify
  // above constant later
  ...
  public static final List<String> DEFAULT_TAG_IDS                                       = Arrays
      .asList(IStandardConfig.StandardProperty.lifestatustag.toString(),
          IStandardConfig.StandardProperty.listingstatustag.toString());
  ...
  public static final String       MINOR_TAXONOMY_BASE_TYPE                              = "com.cs.core.config.interactor.entity.attributiontaxonomy.MasterTaxonomy";
  ...
  public static final String       CREATED_BY_ATTRIBUTE_BASE_TYPE                        = "com.cs.core.config.interactor.entity.standard.attribute.CreatedByAttribute";
  ...
  public static final String       LAST_MODIFIED_BY_ATTRIBUTE_BASE_TYPE                  = "com.cs.core.config.interactor.entity.standard.attribute.LastModifiedByAttribute";
  ...
  public static final List<String> CONTEXTS_TYPES_LIST                                   = Arrays.asList(
      LINKED_VARIANT, ATTRIBUTE_CONTEXT, RELATIONSHIP_VARIANT, GTIN_CONTEXT,
  ...
  // public static final List<String> dateTypeConstants =
  // new ArrayList<String>(
  // Arrays.asList(
  // DATE_ATTRIBUTE_BASE_TYPE,
  // CREATED_ON_ATTRIBUTE_BASE_TYPE,
  // DUE_DATE_ATTRIBUTE_BASE_TYPE,
  // LAST_MODIFIED_ATTRIBUTE_BASE_TYPE));
  ...
  public static final String       RELATIONSHIP_CONTEXT_CAN_EDIT_PERMISSION_INDEX        = "relationshipContextCanEditPermissionIndex";
  ...
  public static final String       STANDARDIZATION_AND_NORMALIZATION                     = "standardization_and_normalization";
  ...
  public static final List<String> PIM_PORTAL_BASE_TYPES                                 = Arrays
      .asList(Constants.ARTICLE_INSTANCE_BASE_TYPE, Constants.ASSET_INSTANCE_BASE_TYPE,
          Constants.TEXTASSET_INSTANCE_BASE_TYPE, Constants.SUPPLIER_INSTANCE_BASE_TYPE, Constants.MARKET_INSTANCE_BASE_TYPE);
  ...
  // ============================ SSO CONSTANT=============================
  public static final String       SSO_VERIFICATION                                      = "/ssoverification";
  public static final String       SSO_VERIFICATION_PATH                                 = "ssoverification";
  public static final String       SSO_CONFIGURATION_MAPPING_JSON_FILE_NAME              = "ssoConfigurationMapping.json";
