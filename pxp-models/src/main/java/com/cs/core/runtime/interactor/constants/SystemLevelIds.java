...
*//**
    * The exact replica of this class is in Neo4j project (Plugin) inside
    * package "com.cs.config.strategy.plugin.constants" Any changes in this
    * class need to be done in the above mentioned class as well
    *
    * @author CS31
    *//*
         ...
         // public static final String PROJECT_KLASS =
         // "com.cs.config.interactor.entity.concrete.klass.ProjectKlass";
         // public static final String TASK_KLASS_KLASS =
         // "com.cs.config.interactor.entity.concrete.klass.Task";
         // public static final String ASSET_KLASS =
         // "com.cs.config.interactor.entity.concrete.klass.Asset";
         // public static final String TARGET_KLASS =
         // "com.cs.config.interactor.entity.concrete.klass.Target";
         // public static final String MARKET_KLASS =
         // "com.cs.config.interactor.entity.concrete.klass.Market";
         public static final String       RELATIONSHIP                                                             = "com.cs.core.config.interactor.entity.relationship.Relationship";
         // public static final String REFERENCE =
         // "com.cs.config.interactor.entity.references.Reference";
         ...
         // public static final String LAST_MODIFIED_ATTRIBUTE =
         ...
         // public static final String TELEPHONE_NUMBER_ATTRIBUTE =
         // "telephonenumberattribute";
         // public static final String DISCOUNT_ATTRIBUTE = "discountattribute";
         // public static final String AUTO_GENERATED_ATTRIBUTE =
         ...
         public static final String[]     METADATA_ATTRIBUTES_IDS                                                  = new String[] {
            I_META_FILE_NAME, I_META_DOCUMENT_TYPE, I_APPLICATION, I_CREATE_DATE, I_MODIFICATION_DATE,
            I_META_FILE_SIZE, I_DIMENSIONS, I_DIMENSION_IN_INCH, I_RESOLUTION, I_BIT_DEPTH, I_COLOR_MODE,
            I_COLOR_PROFILE, I_META_CREATOR_AUTHOR, I_META_CREATOR_STREET, I_META_CREATOR_LOCATION,
            I_META_CREATOR_STATE, I_META_CREATOR_POSTAL_CODE, I_META_CREATOR_COUNTRY, I_META_CREATOR_TEL,
            I_META_CREATOR_EMAIL, I_META_CREATOR_WWW, I_META_HEADING, I_META_DESCRIPTION, I_META_KEYWORDS,
         ...
         public static final String[]     RACIVS_ROLE_IDS                                                          = new String[] {
            RESPONSIBLE, ACCOUNTABLE, CONSULTED, INFORMED, VERIFY, SIGN_OFF, ADMIN_ROLE };
         ...
         // public static final List<String> MANDATORY_TAGS =
         // Arrays.asList(LIFE_STATUS_TAG_ID, LISTING_STATUS_TAG_ID);
         ...
         public static final String       STANDARD_VIRTUALCATALOG_ASSET_RELATIONSHIP_ID                            = "standardVirtualCatalogAssetRelationship";
         ...
         public static final String       STANDARD_MARKETING_ARTICLE_SMART_DOCUMENT_REFRENCE_ID                    = "standardMarketingArticleSmartDocumentReference";
         public static final String       STANDARD_MARKETING_ARTICLE_SMART_DOCUMENT_REFRENCE_SIDE_1_ID             = "standardMarketingArticleSmartDocumentReferenceSide1";
         public static final String       STANDARD_MARKETING_ARTICLE_SMART_DOCUMENT_REFRENCE_SIDE_2_ID             = "standardMarketingArticleSmartDocumentReferenceSide2";
         ...
         // ResolutionContext
         public static final List<String> STANDARD_ENTITY_ASSET_RELATIONSHIPS                                      = Arrays
            .asList(STANDARD_MARKET_ASSET_RELATIONSHIP_ID, STANDARD_ARTICLE_ASSET_RELATIONSHIP_ID,
                STANDARD_PROMOTION_ASSET_RELATIONSHIP_ID, STANDARD_TEXTASSET_ASSET_RELATIONSHIP_ID,
                STANDARD_SUPPLIER_ASSET_RELATIONSHIP_ID);
         
         // ResolutionContext
         public static final String       RESOLUTION_CONTEXT                                                       = "Resolution_Context";
         
         public static final String[]     CONTEXT_IDS                                                              = new String[] { };
         
         public static final String       IMAGE_ATTRIBUTE_INSTANCE                                                 = "com.cs.runtime.interactor.entity.ImageAttributeInstance";
         ...
         // Virtual Catalog Klass
         public static final String       VIRTUAL_CATALOG                                                          = "virtual_catalog";
         ...
         // public static final List<String> MANDATORY_ATTRIBUTES =
         // Arrays.asList(
         // NAME_ATTRIBUTE,
         // CREATED_ON_ATTRIBUTE,
         // CREATED_BY_ATTRIBUTE,
         // LAST_MODIFIED_ATTRIBUTE,
         // LAST_MODIFIED_BY_ATTRIBUTE);
         
         public static final List<String> UNIT_DEFAULT_PC_TAGS                                                     = Arrays
         ...
         // public static final String[] ATTRIBUTE_IDS =
         // new String[] {
         // ASSET_COVERFLOW_ATTRIBUTE,
         // ADDRESS_ATTRIBUTE,
         // DESCRIPTION_ATTRIBUTE,
         // DUE_DATE_ATTRIBUTE,
         // FIRST_NAME_ATTRIBUTE,
         // LIST_PRICE_ATTRIBUTE,
         // LONG_DESCRIPTION_ATTRIBUTE,
         // MINIMUM_PRICE_ATTRIBUTE,
         // PID_ATTRIBUTE,
         // PIN_CODE_ATTRIBUTE,
         // SELLING_PRICE_ATTRIBUTE,
         // SHORT_DESCRIPTION_ATTRIBUTE,
         // SKU_ATTRIBUTE,
         // TELEPHONE_NUMBER_ATTRIBUTE,
         // DISCOUNT_ATTRIBUTE,
         // GTIN_ATTRIBUTE,
         // LAST_NAME_ATTRIBUTE,
         // MAXIMUM_PRICE_ATTRIBUTE,
         // CREATED_BY_ATTRIBUTE,
         // CREATED_ON_ATTRIBUTE,
         // LAST_MODIFIED_ATTRIBUTE,
         // LAST_MODIFIED_BY_ATTRIBUTE,
         ...
         public static final String[]     TAG_IDS                                                                  = new String[] {
            LISTING_STATUS_TAG_ID, LISTING_STATUS_CATLOG, LISTING_STATUS_IGNORED, LISTING_STATUS_REJECTED,
            LISTING_STATUS_ONBOARDING_POOL, LISTING_STATUS_RECOMMENDED, LISTING_STATUS_SHADOW_ASSORTMENT,
            LISTING_STATUS_LISTED, LIFE_STATUS_TAG_ID, LIFE_STATUS_INBOX, LIFE_STATUS_NO_INTEREST,
            LIFE_STATUS_PREPARATION, LIFE_STATUS_ACTIVE, LIFE_STATUS_ACTIVE_BLOCKED,
            LIFE_STATUS_ACTIVE_BANNED, LIFE_STATUS_RETIRED, LIFE_STATUS_ARCHIVED, LIFE_STATUS_DELETED,
            STATUS_TAG, ENRICHMENT_TAG, QUALITY_CHECK_TAG, TRANSLATION_TAG, APPROVAL_TAG, PRODUCTIVE_TAG,
            BLOCKED_FROM_PLANNING, AVAILABILITY_TAG, ON_REQUEST, ON_STOCK, REGULARLY_AVAILABLE,
            DROP_SHIPPING, LANGUAGE_TAG, ENGLISH, GERMAN, SPANISH, ITALIAN, FRENCH, PORTUGESE, SWEDISH };
         
         public static final String[]     PROPERTY_COLLECTION_IDS                                                  = new String[] {
            PRICING_PROPERTY_COLLECTION, ARTICLE_GENERAL_INFORMATION_PROPERTY_COLLECTION,
            MARKET_GENERAL_INFORMATION_PROPERTY_COLLECTION,
            ASSET_GENERAL_INFORMATION_PROPERTY_COLLETION,
            PROMOTION_GENERAL_INFORMATION_PROPERTY_COLLECTION,
            SUPPLIER_GENERAL_INFORMATION_PROPERTY_COLLECTION,
            TEXTASSET_GENERAL_INFORMATION_PROPERTY_COLLECTION, DEFAULT_X_RAY_PROPERTY_COLLECTION,
            METADATA_COLLECTION, UNIT_DEFAULT_PC_ID };
         
         public static final String[]     TARGET_IDS                                                               = new String[] {
            MARKET};
         
         public static final String[]     ROLE_IDS                                                                 = new String[] {
            APPROVER_ROLE, OWNER_ROLE, SUBSCRIBER_ROLE, CONTRIBUTOR_ROLE, REVIEWER_ROLE,
            SENIOR_MANAGER_ROLE, ASSIGNEE_ROLE };
         ...
         public static final String[]     RELATIONSHIP_IDS                                                         = new String[] {
            ...
            STANDARD_TEXTASSET_ASSET_RELATIONSHIP_ID, STANDARD_SUPPLIER_ASSET_RELATIONSHIP_ID,
            STANDARD_PROMOTION_ASSET_RELATIONSHIP_ID, STANDARD_ARTICLE_MARKET_RELATIONSHIP_ID,
            STANDARD_VIRTUALCATALOG_ASSET_RELATIONSHIP_ID,
            STANDARD_ARTICLE_GOLDEN_ARTICLE_RELATIONSHIP_ID };
         ...
         public static final List<String> DATE_TYPE                                                                = Arrays
            .asList(IConfigClass.PropertyClass.DATE_ATTRIBUTE_TYPE.toString(),
                IConfigClass.PropertyClass.CREATED_ON_ATTRIBUTE_TYPE.toString(),
                IConfigClass.PropertyClass.DUE_DATE_ATTRIBUTE_TYPE.toString(),
                IConfigClass.PropertyClass.LAST_MODIFIED_ATTRIBUTE_TYPE.toString());
         ...
         public static final String       USAGE_TAB                                                                = "usage_tab";
         
         public static final String       DUPLICATE_TAB                                                            = "duplicate_tab";
         
         public static final String[]     PIM_KLASS_IDS                                                            = new String[] {
            ARTICLE, PRODUCT_TYPES, CHANNEL_CLASSES, ATTRIBUTION_CLASSES, SINGLE_ARTICLE, FILE, MARKER,
            GOLDEN_ARTICLE_KLASS };
         public static final String[]     MAM_KLASS_IDS                                                            = new String[] {
            ATTACHMENT, ASSET, IMAGE, VIDEO, DOCUMENT, SMARTDOCUMENT_ASSET };
         ...
         public static final List<String> KLASSES_TO_EXCLUDE_FROM_CONFIG_SCREEN                                    = Arrays
            .asList(MARKER, GOLDEN_ARTICLE_KLASS, FILE);
         
         public static final String       LANGUAGE_TREE                                                            = "language";
         
         public static final String[]     STANDARD_TABS                                                            = new String[] {
            OVERVIEW_TAB, PROPERTY_COLLECTION_TAB, RELATIONSHIP_TAB, CONTEXT_TAB, TASK_TAB, 
            TIMELINE_TAB, RENDITION_TAB,
            DUPLICATE_TAB, USAGE_TAB };
         
         public static final String[]     VIRTUAL_CATALOG_KLASS_IDS                                                = new String[] {
            VIRTUAL_CATALOG };
         
         public static final List<String> RACVIS_ROLES                                                             = Arrays
            .asList(RESPONSIBLE, ACCOUNTABLE, CONSULTED, INFORMED, VERIFY, SIGN_OFF);
