...
public class CalculatedAttributeModel extends AbstractAttributeModel
    implements ICalculatedAttributeModel {
  
  private static final long serialVersionUID = 1L;
  
  public CalculatedAttributeModel()
  {
    super(new CalculatedAttribute(), Renderer.CALCULATED.toString());
  }
  
  public CalculatedAttributeModel(ICalculatedAttribute attribute)
  {
