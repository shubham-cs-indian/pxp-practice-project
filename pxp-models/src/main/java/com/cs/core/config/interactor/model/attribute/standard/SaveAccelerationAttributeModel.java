...
public class SaveAccelerationAttributeModel extends AbstractSaveUnitAttributeModel
    implements IAccelerationAttributeModel {
  
  private static final long serialVersionUID = 1L;
  
  public SaveAccelerationAttributeModel()
  {
    super(new AccelerationAttribute(), Renderer.ACCELERATION.toString());
  }
  
  public SaveAccelerationAttributeModel(IAccelerationAttribute attribute)
  {
