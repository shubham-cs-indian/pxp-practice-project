...
public class SaveImageAttributeModel extends AbstractSaveAttributeModel
    implements IImageAttributeModel {
  
  private static final long serialVersionUID = 1L;
  
  public SaveImageAttributeModel()
  {
    super(new ImageAttribute(), Renderer.IMAGE.toString());
  }
  
  public SaveImageAttributeModel(IImageAttribute attribute)
  {
