...
public class ConditionInformationModel implements IConditionInformationModel {
  
  protected IDataRule dataRule;
  
  public ConditionInformationModel()
  {
    this.dataRule = new DataRule();
  }
  
  public ConditionInformationModel(IDataRule dataRule)
  {
