...
public interface ISaveMappingModel extends IModel, IMapping {
  ...
  public static final String MODIFIED_CONTEXT_MAPPINGS        = "modifiedContextMappings";
 ...
 public void setPropertyCollectionMappings(List<IConfigRulePropertyMappingModel> propertyCollectionMappings);
