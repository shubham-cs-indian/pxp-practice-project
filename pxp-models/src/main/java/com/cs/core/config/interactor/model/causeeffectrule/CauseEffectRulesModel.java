package com.cs.core.config.interactor.model.causeeffectrule;
...
public class CauseEffectRulesModel extends ConfigResponseWithAuditLogModel implements ICauseEffectRulesModel {
