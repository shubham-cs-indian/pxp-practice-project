...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, defaultImpl = CreateRoleModel.class,
    include = JsonTypeInfo.As.PROPERTY, property = "type", visible = true)
public class CreateRoleModel implements ICreateRoleModel {
  ...
  public CreateRoleModel(IRole role)
  {
    entity = role;
  }
