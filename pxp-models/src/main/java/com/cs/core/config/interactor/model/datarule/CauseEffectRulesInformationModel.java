...
public class CauseEffectRulesInformationModel implements ICauseEffectRulesInformationModel {
  
  private static final long serialVersionUID = 1L;
  protected IDataRule       dataRule;
  
  public CauseEffectRulesInformationModel()
  {
    this.dataRule = new DataRule();
  }
  
  public CauseEffectRulesInformationModel(IDataRule dataRule)
  {
