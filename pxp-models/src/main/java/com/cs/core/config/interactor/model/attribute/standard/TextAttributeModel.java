...
public class TextAttributeModel extends AbstractAttributeModel implements ITextAttributeModel {
  
  private static final long serialVersionUID = 1L;
  
  public TextAttributeModel()
  {
    super(new TextAttribute(), Renderer.TEXT.toString());
  }
  
  public TextAttributeModel(ITextAttribute attribute)
  {
