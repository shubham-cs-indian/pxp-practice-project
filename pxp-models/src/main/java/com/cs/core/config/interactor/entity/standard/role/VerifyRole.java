...
@Component()
@Scope("prototype")
public class VerifyRole extends AbstractMandatoryRole implements IVerifyRole {
  
  private static final long                serialVersionUID = 1L;
  protected String                         id               = SystemLevelIds.VERIFY;
  protected String                         label            = SystemLabels.VERIFY_ROLE_LABEL;
  ...
  protected String                         code             = SystemLevelIds.VERIFY;
  protected String                         roleType         = CommonConstants.USER;
  
  public VerifyRole()
  {
  }
  
  public VerifyRole(String label)
  {
    this.label = label;
  }
