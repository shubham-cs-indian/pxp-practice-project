...
public interface IGetKlassTaxonomyTreeForCollectionService
    extends IRuntimeService<IGetKlassTaxonomyTreeRequestModel, IGetKlassTaxonomyTreeResponseModel> {
