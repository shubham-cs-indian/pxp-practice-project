...
var HtmlAttributeConfigGridSkeleton = function () {
  return{
    fixedColumns: [
      {
        id: "icon",
    ...
    scrollableColumns: [
      ...
      {
        id: "allowedRTEIcons",
        label: getTranslations().ALLOWED_STYLE,
      ...
      /*{
        id: "defaultStyles",
        label: getTranslations().DEFAULT_STYLES,
        type: oGridViewPropertyTypes.DROP_DOWN,
        isVisible: true,
        width: 200
      },*/
...
export default HtmlAttributeConfigGridSkeleton;