...
var CalculatedAttributeConfigGridSkeleton = function () {
  return{
    fixedColumns: [
      {
        id: "icon",
    ...
    scrollableColumns: [
      {
        id: "precision",
        label: getTranslations().PRECISION,
      ...
      {
        id: "calculatedAttributeFormula",
        label: getTranslations().CALCULATED_FORMULA,
        type: oGridViewPropertyTypes.CALCULATED_FORMULA,
        isVisible: true,
        width: 400,
        extraData: {}
      },
      ...
      {
        id: "hideSeparator",
        label: getTranslations().HIDE_SEPARATOR,
        type: oGridViewPropertyTypes.YES_NO,
        isVisible: true,
        width: 150
      },
...
export default CalculatedAttributeConfigGridSkeleton;