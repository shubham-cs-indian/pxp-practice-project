...
var MeasurementAttributeConfigGridSkeleton = function () {
  return{
    fixedColumns: [
      {
        id: "icon",
    ...
    scrollableColumns: [
      {
        id: "measurementAttributeType",
        label: getTranslations().MEASUREMENT_ATTRIBUTE_TYPE,
      ...
      {
        id: "defaultUnit",
        label: getTranslations().DEFAULT_UNIT,
...
export default MeasurementAttributeConfigGridSkeleton;