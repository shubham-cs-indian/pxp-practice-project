...
const _injectFroalaLicense = () => {
  try {
    (function (k) {
      localStorage.FEK = k;
    })(process.env.REACT_APP_FROALA_LICENSE)
  } catch (e) {
  }
};

_injectFroalaLicense();
_renderHomeScreen();
