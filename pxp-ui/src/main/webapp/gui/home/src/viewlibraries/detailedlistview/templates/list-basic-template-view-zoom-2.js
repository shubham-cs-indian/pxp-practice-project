...
/**
 * @class ListBasicTemplateViewZoom2
 * @memberOf Views
...
// @CS.SafeComponent
class ListBasicTemplateViewZoom2 extends React.Component {
  ...
  render() {
    ...
    return (
        <div className={"basicTemplateContainerZoom2 " + sTheme + sIsOpenable} onClick={fSingleClickHandler} style={oCursorStyle}>
...
ListBasicTemplateViewZoom2.propTypes = oPropTypes;

export const view = ListBasicTemplateViewZoom2;
