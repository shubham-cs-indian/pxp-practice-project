...
/**
 * @class ListBasicTemplateViewZoom3
 * @memberOf Views
...
// @CS.SafeComponent
class ListBasicTemplateViewZoom3 extends React.Component {
  ...
  render() {
    ...
    return (
        <div className={"basicTemplateContainerZoom3 " + sTheme + sIsOpenable} onClick={fSingleClickHandler} style={oCursorStyle}>
...
ListBasicTemplateViewZoom3.propTypes = oPropTypes;

export const view = ListBasicTemplateViewZoom3;
