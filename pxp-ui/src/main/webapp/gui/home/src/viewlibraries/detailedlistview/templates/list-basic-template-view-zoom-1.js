...
/**
 * @class ListBasicTemplateViewZoom1
 * @memberOf Views
 * @property {string} [id] - Id of content
 * @property {string} [name] - Name of the content.
 * @property {string} [className] - Contain label of primary type.
...
// @CS.SafeComponent
class ListBasicTemplateViewZoom1 extends React.Component {
  ...
  render() {
    ...
    return (
        <div className={"basicTemplateContainerZoom1 " + sTheme + sIsOpenable} onClick={fSingleClickHandler} style={oCursorStyle}>
...
ListBasicTemplateViewZoom1.propTypes = oPropTypes;

export const view = ListBasicTemplateViewZoom1;
