...
public class GetLanguageController extends BaseController implements IConfigController {
  ...
  {
    IIdParameterModel parameterModel = new IdParameterModel(id);
    return createResponse(getLanguage.execute(parameterModel));
  }
}
