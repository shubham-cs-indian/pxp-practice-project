...
public class GetIconEntityUsesesController extends BaseController implements IConfigController {
  
  @Autowired
  protected IGetAllIcons getAllIconController;
  
  @RequestMapping(value = "/icons/geticonentityuseses", method = RequestMethod.POST)
