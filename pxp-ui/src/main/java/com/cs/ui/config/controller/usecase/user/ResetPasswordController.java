...
import com.cs.core.config.interactor.usecase.user.IResetPassword;
...
public class ResetPasswordController extends BaseController implements IConfigController {
  ...
  public IRESTModel execute(@RequestBody UserModel userModel) throws Exception
  {
    ...
    return createResponse(resetPassword.execute(userModel));
  }
}
