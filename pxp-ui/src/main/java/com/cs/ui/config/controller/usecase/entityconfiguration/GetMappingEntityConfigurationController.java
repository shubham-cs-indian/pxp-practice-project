...
public class GetMappingEntityConfigurationController extends BaseController implements IConfigController {

  @Autowired
  protected IGetEntityConfiguration getMappingEntityConfiguration;

  @RequestMapping(value = "/getentityconfig/mapping", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
    return createResponse(getMappingEntityConfiguration.execute(model));
  }
