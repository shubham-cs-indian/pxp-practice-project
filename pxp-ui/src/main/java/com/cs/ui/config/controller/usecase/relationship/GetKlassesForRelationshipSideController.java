...
public class GetKlassesForRelationshipSideController extends BaseController
    implements IConfigController {
  
  @Autowired
  IGetKlassesForRelationshipSide getKlassesForRelationshipSide;
  
  @RequestMapping(value = "/klassesForRelationshipSide/{id}", method = RequestMethod.GET)
  public IRESTModel execute(@PathVariable String id) throws Exception
  {
    ...
    return createResponse(getKlassesForRelationshipSide.execute(getEntityModel));
  }
}
