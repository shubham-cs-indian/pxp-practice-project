...
public class GetTaxonomyEntityConfigurationController extends BaseController implements IConfigController {

  @Autowired
  protected IGetEntityConfiguration getTaxonomyEntityConfiguration;

  @RequestMapping(value = "/getentityconfig/attributionTaxonomy", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
    return createResponse(getTaxonomyEntityConfiguration.execute(model));
  }
