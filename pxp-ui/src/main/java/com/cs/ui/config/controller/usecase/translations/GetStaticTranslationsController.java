...
import com.cs.core.config.interactor.usecase.translations.IGetStaticTranslations;
...
public class GetStaticTranslationsController extends BaseController implements IConfigController {
  
  @Autowired
  protected IGetStaticTranslations getStaticTranslations;
  ...
  {
    return createResponse(getStaticTranslations.execute(model));
  }
}
