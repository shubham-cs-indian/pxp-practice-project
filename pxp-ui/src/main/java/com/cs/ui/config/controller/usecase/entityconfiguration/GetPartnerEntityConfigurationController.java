...
public class GetPartnerEntityConfigurationController extends BaseController implements IConfigController {

	@Autowired
	protected IGetEntityConfiguration getPartnerEntityConfiguration;

	@RequestMapping(value = "/getentityconfig/organisationConfigInformation", method = RequestMethod.POST)
	public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
		return createResponse(getPartnerEntityConfiguration.execute(model));
	}
