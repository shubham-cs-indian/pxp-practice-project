...
public class GetIconEntityConfigurationController extends BaseController implements IConfigController {

  @Autowired
  protected IGetEntityConfiguration getIconEntityConfiguration;

  @RequestMapping(value = "/getentityconfig/icon", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
    return createResponse(getIconEntityConfiguration.execute(model));
  }
