...
public class GetRelationshipEntityConfigurationController extends BaseController implements IConfigController {

  @Autowired
  protected IGetEntityConfiguration getRelationshipEntityConfiguration;

  @RequestMapping(value = "/getentityconfig/relationship", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
    return createResponse(getRelationshipEntityConfiguration.execute(model));
  }
