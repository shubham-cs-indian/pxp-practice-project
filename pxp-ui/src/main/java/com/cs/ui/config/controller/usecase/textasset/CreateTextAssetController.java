...
public class CreateTextAssetController extends BaseController implements IConfigController {
  
  @Autowired
  ICreateTextAsset createTextAsset;
  
  @RequestMapping(value = "/textassets", method = RequestMethod.PUT)
  public IRESTModel execute(@RequestBody AbstractKlassModel marketModel) throws Exception
  {
    return createResponse(createTextAsset.execute((ITextAssetModel) marketModel));
  }
}
