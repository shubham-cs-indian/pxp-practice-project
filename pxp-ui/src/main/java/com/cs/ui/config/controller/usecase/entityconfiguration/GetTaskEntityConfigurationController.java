...
public class GetTaskEntityConfigurationController extends BaseController implements IConfigController {

  @Autowired
  protected IGetEntityConfiguration getTaskEntityConfiguration;

  @RequestMapping(value = "/getentityconfig/task", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
    return createResponse(getTaskEntityConfiguration.execute(model));
  }
