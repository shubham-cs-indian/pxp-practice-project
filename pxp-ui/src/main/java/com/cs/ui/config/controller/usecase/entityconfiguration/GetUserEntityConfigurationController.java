...
public class GetUserEntityConfigurationController extends BaseController implements IConfigController {

  @Autowired
  protected IGetEntityConfiguration getUserEntityConfiguration;

  @RequestMapping(value = "/getentityconfig/user", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
    return createResponse(getUserEntityConfiguration.execute(model));
  }
