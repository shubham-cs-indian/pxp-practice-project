...
public class GetTagEntityConfigurationController extends BaseController implements IConfigController {

  @Autowired
  protected IGetEntityConfiguration getTagEntityConfiguration;

  @RequestMapping(value = "/getentityconfig/tag", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
    return createResponse(getTagEntityConfiguration.execute(model));
  }
