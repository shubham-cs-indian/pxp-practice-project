...
public class GetKlasstEntityConfigurationController extends BaseController implements IConfigController {

  @Autowired
  protected IGetEntityConfiguration getKlassEntityConfiguration;

  @RequestMapping(value = "/getentityconfig/class", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
    return createResponse(getKlassEntityConfiguration.execute(model));
  }
