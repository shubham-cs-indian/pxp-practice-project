...
public class GetAttributeEntityConfigurationController extends BaseController implements IConfigController {

	@Autowired
	protected IGetEntityConfiguration getAttributeEntityConfiguration;

	@RequestMapping(value = "/getentityconfig/attribute", method = RequestMethod.POST)
	public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
		return createResponse(getAttributeEntityConfiguration.execute(model));
	}
