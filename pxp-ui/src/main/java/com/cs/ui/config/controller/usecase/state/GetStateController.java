...
import com.cs.core.config.interactor.usecase.state.IGetState;
...
public class GetStateController extends BaseController implements IConfigController {
  ...
  public IRESTModel execute(@PathVariable String id) throws Exception
  {
    ...
    return createResponse(getState.execute(getEntityModel));
  }
}
