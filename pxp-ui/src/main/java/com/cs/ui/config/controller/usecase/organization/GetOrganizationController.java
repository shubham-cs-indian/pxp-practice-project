...
public class GetOrganizationController extends BaseController implements IConfigController {
  
  @Autowired
  protected IGetOrganization getOrganization;
  ...
  public IRESTModel execute(@PathVariable String id) throws Exception
  {
    ...
    return createResponse(getOrganization.execute(getEntityModel));
  }
}
