...
public class GetRuleListEntityConfigurationController extends BaseController
    implements IConfigController {
  
  @Autowired
  protected IGetEntityConfiguration getRuleListEntityConfiguration;
  
  @RequestMapping(value = "/getentityconfig/rulelist", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception
  {
    return createResponse(getRuleListEntityConfiguration.execute(model));
  }
}
