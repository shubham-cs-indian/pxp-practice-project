...
public class GetContextEntityConfigurationController extends BaseController implements IConfigController {

  @Autowired
  protected IGetEntityConfiguration getContextEntityConfiguration;

  @RequestMapping(value = "/getentityconfig/context_variant", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody GetEntityConfigurationRequestModel model) throws Exception {
    return createResponse(getContextEntityConfiguration.execute(model));
  }
