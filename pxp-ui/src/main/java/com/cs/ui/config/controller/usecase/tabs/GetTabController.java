...
public class GetTabController extends BaseController implements IConfigController {
  
  @Autowired
  protected IGetTab getTab;
  ...
  public IRESTModel execute(@PathVariable String id) throws Exception
  {
    ...
    return createResponse(getTab.execute(getEntityModel));
  }
}
