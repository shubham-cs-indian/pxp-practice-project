...
public class GetSupplierWithoutKPController extends BaseController implements IConfigController {
  
  @Autowired
  IGetSupplierWithoutKP getSupplierWithoutKP;
  
  @RequestMapping(value = "/supplierwithoutkp/{id}", method = RequestMethod.GET)
  public IRESTModel execute(@PathVariable String id) throws Exception
  {
    ...
    return createResponse(getSupplierWithoutKP.execute(getEntityModel));
  }
}
