...
public class GetTypesAndTaxonomiesOfContentController extends BaseController
    implements IRuntimeController {
  
  @Autowired
  protected IGetTypesAndTaxonomiesOfContent getTypesAndTaxonomiesOfContent;
  
  @RequestMapping(value = "/typesandtaxonomiesofcontent", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody AllowedTypesRequestModel model) throws Exception
  {
    return createResponse(getTypesAndTaxonomiesOfContent.execute(model));
  }
}