...
public class QuickListMarketInstanceForRelationshipController extends BaseController
    implements IRuntimeController {
  
  @Autowired
  IQuickListMarketInstanceForRelationship quickListMarketInstanceForRelationship;
  
  @RequestMapping(value = "/marketinstance/relationship/quicklist", method = RequestMethod.POST)
  public IRESTModel execute(@RequestBody RelationshipInstanceQuickListModel quickListModel)
      throws Exception
  {
    return createResponse(quickListMarketInstanceForRelationship.execute(quickListModel));
  }
}