...
public class CreateMarketInstanceVariantForLimitedObjectController extends BaseController
    implements IRuntimeController {
  
  @Autowired
  protected ICreateMarketInstanceVariantForLimitedObject createMarketInstanceVariantForLimitedObject;
  
  @RequestMapping(value = "/market/variant/limitedobject", method = RequestMethod.PUT)
  public IRESTModel execute(@RequestBody CreateVariantForLimitedObjectRequestModel createVariantModel) throws Exception
  {
    return createResponse(createMarketInstanceVariantForLimitedObject.execute(createVariantModel));
  }
