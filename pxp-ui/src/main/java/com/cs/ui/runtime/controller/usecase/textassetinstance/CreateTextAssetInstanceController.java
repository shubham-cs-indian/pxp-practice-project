...
public class CreateTextAssetInstanceController extends BaseController implements IRuntimeController {
  @Autowired
  ICreateTextAssetInstance createTextAssetInstance;
  
  @RequestMapping(value = "/textassetinstances", method = RequestMethod.PUT)
  public IRESTModel execute(@RequestBody CreateInstanceModel klassInstanceModel) throws Exception
  {
    return createResponse(createTextAssetInstance.execute(klassInstanceModel));
  }
}
