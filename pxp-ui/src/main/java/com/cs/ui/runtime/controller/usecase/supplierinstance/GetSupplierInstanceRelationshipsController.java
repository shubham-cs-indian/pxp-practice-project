...
import com.cs.pim.runtime.interactor.usecase.supplierinstance.IGetSupplierInstanceRelationships;
import com.cs.ui.runtime.controller.model.response.IRESTModel;
import com.cs.ui.runtime.controller.usecase.interceptor.BaseController;

@RestController
@RequestMapping(value = "/runtime")
public class GetSupplierInstanceRelationshipsController extends BaseController implements IRuntimeController {
  
  @Autowired
  IGetSupplierInstanceRelationships getSupplierRelationshipInstances;
  
  @RequestMapping(value = "/supplierinstancesrelationships/{id}", method = RequestMethod.POST)
  public IRESTModel execute(@PathVariable String id, @RequestBody KlassInstanceRelationshipsFilterModel filterModel) throws Exception
  {
    ...
    return createResponse(getSupplierRelationshipInstances.execute(model));
  }
}
