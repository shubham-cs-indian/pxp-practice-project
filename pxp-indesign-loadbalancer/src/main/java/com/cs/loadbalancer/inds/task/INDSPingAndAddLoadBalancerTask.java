 ...
 */
public class INDSPingAndAddLoadBalancerTask extends BaseINDSTask implements IINDSTask {

	public INDSPingAndAddLoadBalancerTask(AsyncContext asyncContext, IINDSScheduler scheduler,
	...
	public void performTask() throws Exception {
		...
		scheduler.updateAndAddINDS(inDesignServerInstances);
