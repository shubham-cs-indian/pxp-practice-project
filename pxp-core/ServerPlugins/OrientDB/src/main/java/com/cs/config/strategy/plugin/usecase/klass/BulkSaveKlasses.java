...
public class BulkSaveKlasses extends AbstractOrientPlugin {
  
  public static ThreadLocal<Map<String, String>> threadLocalAddedStructrureIdMapping = new ThreadLocal<>();
  
  public BulkSaveKlasses(final OServerCommandConfiguration iConfiguration)
  {
  ...
  public Object execute(Map<String, Object> map) throws Exception
  {
    ...
    threadLocalAddedStructrureIdMapping.set(new HashMap<>());
    
    UtilClass.setReferencedKlassIdStructureMapping(new HashMap<>());
  ...
  {
    return new String[] { "POST|BulkSaveKlasses/*" };
  }
}
