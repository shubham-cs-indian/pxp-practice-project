...
public class BulkCreateAssets extends AbstractOrientPlugin {
  
  public BulkCreateAssets(final OServerCommandConfiguration iConfiguration)
  {
  ...
  {
    List<Map<String, Object>> klassList = (List<Map<String, Object>>) map.get("list");
  ...
  {
    return new String[] { "POST|BulkCreateAssets/*" };
  }
}
