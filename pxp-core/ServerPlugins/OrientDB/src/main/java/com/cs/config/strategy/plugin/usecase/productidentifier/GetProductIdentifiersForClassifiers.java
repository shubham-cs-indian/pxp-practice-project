...
public class GetProductIdentifiersForClassifiers extends AbstractOrientPlugin{

  public GetProductIdentifiersForClassifiers(OServerCommandConfiguration iConfiguration)
  {
  ...
  {
    return new String[] { "POST|GetProductIdentifiersForClassifiers/*" };
  }
  ...
  protected Object execute(Map<String, Object> requestMap) throws Exception
  {
    ...
    List<String> classifiers = (List<String>) requestMap.get("classifiers");
    ...
    List<String> removedClassifiers = (List<String>) requestMap.get("removedClassifiers");
  ...
  private void fillIdentifiers(Map<Long, List<Long>> productIdentifiers, Set<Long> mustIdentifiers, Set<Long> shouldIdentifiers,
      Set<Long> translatablePropertyIIDs, List<String> classifiers, Map<String, Object> referencedElements,
      Map<String, Object> referencedAttributes, Map<String, Object> referencedTags) throws Exception, NotFoundException
  {
    ...
    for (String classifier : classifiers) {
      ...
      try {
        classifierNode = UtilClass.getVertexByCode(classifier, VertexLabelConstants.ENTITY_TYPE_ROOT_KLASS);
      }
      catch(NotFoundException e) {
        classifierNode = UtilClass.getVertexByCode(classifier, VertexLabelConstants.ROOT_KLASS_TAXONOMY);
      }
      ...
      for(Vertex kpNode : kpNodes) {
        ...
        if(!shouldIdentifiers.contains(propertyiid) && (Boolean)kpNode.getProperty(ISectionAttribute.IS_SHOULD)) {
		  ...
		  fillReferencedElemnetsData(kpNode, classifier, referencedElements, referencedAttributes, referencedTags);
      }
