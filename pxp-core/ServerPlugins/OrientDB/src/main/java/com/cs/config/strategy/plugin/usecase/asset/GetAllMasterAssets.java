...
public class GetAllMasterAssets extends AbstractOrientPlugin {
  
  public GetAllMasterAssets(final OServerCommandConfiguration iConfiguration)
  {
  ...
  public Object execute(Map<String, Object> map) throws Exception
  {
    ...
    while (assetNodesIterator.hasNext()) {
      ...
      assetsList.add(AssetUtils.getAssetEntityMap(assetNode, null));
    }
  ...
  {
    return new String[] { "POST|GetAllMasterAssets/*" };
  }
}
