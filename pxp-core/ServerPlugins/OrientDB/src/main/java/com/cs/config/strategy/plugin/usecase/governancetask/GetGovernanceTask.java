...
public class GetGovernanceTask extends AbstractOrientPlugin {
  
  public GetGovernanceTask(final OServerCommandConfiguration iConfiguration)
  {
  ...
  {
    return new String[] { "POST|GetGovernanceTask/*" };
  }
}
