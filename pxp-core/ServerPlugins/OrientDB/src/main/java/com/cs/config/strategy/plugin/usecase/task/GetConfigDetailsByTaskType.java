...
public class GetConfigDetailsByTaskType extends AbstractOrientPlugin {
  
  public GetConfigDetailsByTaskType(final OServerCommandConfiguration iConfiguration)
  {
  ...
  {
    return new String[] { "POST|GetConfigDetailsByTaskType/*" };
  }
