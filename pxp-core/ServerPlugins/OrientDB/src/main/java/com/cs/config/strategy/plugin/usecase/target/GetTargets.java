...
public class GetTargets extends AbstractOrientPlugin {
  
  public GetTargets(final OServerCommandConfiguration iConfiguration)
  {
  ...
  {
    return new String[] { "POST|GetTargets/*" };
  }
}
