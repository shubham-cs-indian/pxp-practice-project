...
public class GetSectionInfoForTaxonomy extends AbstractOrientPlugin {
  
  public GetSectionInfoForTaxonomy(final OServerCommandConfiguration iConfiguration)
  {
  ...
  {
    String taxonomyId = (String) requestMap.get(IGetSectionInfoForTypeRequestModel.TYPE_ID);
    ...
    KlassUtils.addSectionsToKlassMap(taxonomyNode, klassEntityMap, sectionNodes.iterator(), true);
  ...
  {
    return new String[] { "POST|GetSectionInfoForTaxonomy/*" };
  }
}
