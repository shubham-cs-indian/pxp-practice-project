...
import com.cs.config.strategy.plugin.usecase.base.attributiontaxonomy.AbstractGetMasterTaxonomy;
...
public class GetMasterTaxonomy extends AbstractGetMasterTaxonomy {
  
  public GetMasterTaxonomy(final OServerCommandConfiguration iConfiguration)
  {
  ...
  {
    return new String[] { "POST|GetMasterTaxonomy/*" };
  }
