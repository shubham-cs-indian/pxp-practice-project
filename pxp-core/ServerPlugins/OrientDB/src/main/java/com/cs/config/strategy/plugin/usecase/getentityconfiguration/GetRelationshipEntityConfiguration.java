...
public class GetRelationshipEntityConfiguration extends AbstractOrientPlugin {
  
  public GetRelationshipEntityConfiguration(OServerCommandConfiguration iConfiguration)
  {
  ...
  {
    return new String[] { "POST|GetRelationshipEntityConfiguration/*" };
  }
  ...
  protected Object execute(Map<String, Object> requestMap) throws Exception
  {
    ...
    for (String id : Ids) {
      Map<String, Object> details = getRelationshipEntityUsageSummary(id);
  ...
  /**
   * Description: get usage summary of relationship type entity
   *
   ...
   * @throws Exception
   */
  protected Map<String, Object> getRelationshipEntityUsageSummary(String id) throws Exception
  {
    ...
    GetEntityConfigurationUtils.setGoldenRecordMergeConfiguration(nodeId, referenceData, usedBy,
        ...
        EntityConfigurationConstants.GOLDEN_RECORD,
    ...
    GetEntityConfigurationUtils.setTwoLevelQuery(nodeId, Direction.IN, Direction.IN, referenceData,
        usedBy, usageSummary, RelationshipLabelConstants.HAS_INHERITANCE_RELATIONSHIP,
        RelationshipLabelConstants.KLASS_NATURE_RELATIONSHIP_OF,
        EntityConfigurationConstants.RELATIONSHIP_INHERITANCE);
