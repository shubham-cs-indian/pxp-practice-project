...
public class GetFilterAndSortDataForKlass extends AbstractGetFilterAndSortDataForKlass {
  
  public GetFilterAndSortDataForKlass(final OServerCommandConfiguration iConfiguration)
  {
  ...
  {
    return new String[] { "POST|GetFilterAndSortDataForKlass/*" };
  }
