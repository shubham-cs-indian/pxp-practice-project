...
public abstract class AbstractGetPostConfigDetailsForStaticCollection extends AbstractOrientPlugin {
  
  public AbstractGetPostConfigDetailsForStaticCollection(
