...
@Service
public class GetTaskEntityConfiguration extends 
AbstractGetConfigInteractor<IGetEntityConfigurationRequestModel, IGetEntityConfigurationResponseModel>
  ...
  @Override
  public IGetEntityConfigurationResponseModel executeInternal(IGetEntityConfigurationRequestModel dataModel) throws Exception
  {
    return getTaskEntityConfigurationStrategy.execute(dataModel);
  }
