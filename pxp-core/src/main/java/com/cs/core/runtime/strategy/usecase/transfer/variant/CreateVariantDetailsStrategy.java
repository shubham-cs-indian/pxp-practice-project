...
@Component
public class CreateVariantDetailsStrategy extends BasePostgresStrategy
    implements ICreateVariantDetailsStrategy {
  ...
  {
    dbUtils.insertQuery(TransferConstants.VARIANT_STATUS_TABLE, dbUtils.getModelIntoMap(model));
    return null;
  }
}
