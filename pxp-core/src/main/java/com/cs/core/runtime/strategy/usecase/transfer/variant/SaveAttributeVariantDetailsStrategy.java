...
@Component
public class SaveAttributeVariantDetailsStrategy extends BasePostgresStrategy
    implements ISaveAttributeVariantDetailsStrategy {
  ...
  {
    dbUtils.updateQuery(TransferConstants.ATTRIBUTE_VARIANT_STATUS_TABLE, getColumnValue(model),
