...
@Component
public class GetAllVariantIdsByProcessIdStrategy extends BasePostgresStrategy
    implements IGetAllVariantIdsByProcessIdStrategy {
  ...
  public IIdsListParameterModel execute(IGetAllInstanceIdByProcessIdsModel model) throws Exception
  {
    ...
    List<Map<String, Object>> executeQueryWithResult = dbUtils.selectQuery(
        TransferConstants.VARIANT_STATUS_TABLE, columnNamesToFetch, getCondtionalColumns(model));
