...
@Component
public class CreateRealtionshipDetailsStrategy extends BasePostgresStrategy
    implements ICreateRelationshipDetailsStrategy {
  ...
  {
    dbUtils.insertQuery(TransferConstants.RELATIONSHIP_STATUS_TABLE,
