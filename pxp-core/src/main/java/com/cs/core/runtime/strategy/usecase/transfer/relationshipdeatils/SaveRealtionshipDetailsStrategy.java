...
@Component
public class SaveRealtionshipDetailsStrategy extends BasePostgresStrategy
    implements ISaveRelationshipDetailsStrategy {
  ...
  {
    dbUtils.updateQuery(TransferConstants.RELATIONSHIP_STATUS_TABLE, getColumnValue(model),
