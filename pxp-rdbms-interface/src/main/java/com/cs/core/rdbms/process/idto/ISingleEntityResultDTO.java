 ...
 * @author vallee
 */
public interface ISingleEntityResultDTO {
  ...
  /**
   * @return the set of base entity IIDs that fails to a KPI Notice: return the non-green entity IIDs for a data quality rule
   */
