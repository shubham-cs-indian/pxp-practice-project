...
public interface IGetAssetPropertiesVariantInstancesInTableView extends
    IRuntimeInteractor<IGetPropertiesVariantInstanceInTableViewRequestModel, IGetPropertiesVariantInstancesInTableViewModel> {
