 ...
 */
@Service
public class DeleteAssetFromSharedSwiftServer
    extends AbstractRuntimeInteractor<IIdParameterModel, IIdParameterModel>
    implements IDeleteAssetFromSharedSwiftServer {
  ...
  protected IIdParameterModel executeInternal(IIdParameterModel model) throws Exception
  {
    ...
    int response = CSDAMServer.instance()
        .deleteAssetFromSwiftServer(assetDeleteRequestDetails);
    if (response == 404) {
    ...
    if (response == 401) {
      CSDAMServer.instance()
          .connect();
      Map<String, Object> serverDetails = (Map<String, Object>) assetDeleteRequestDetails
          .get("assetServerDetails");
      serverDetails.put("storageUrl", CSDAMServer.instance()
          .getServerInformation()
          .getInitField(CSDAMServer.RESPONSE_HEADER_STORAGE_URL, ""));
      serverDetails.put("authToken", CSDAMServer.instance()
          .getServerInformation()
          .getInitField(CSDAMServer.RESPONSE_HEADER_STORAGE_URL, ""));
      CSDAMServer.instance()
          .deleteAssetFromSwiftServer(assetDeleteRequestDetails);
   ...
   */
  private void fillAssetRequestMapDetails(IIdParameterModel model,
      Map<String, Object> assetDeleteRequestDetails, Map<String, String> assetServerDetails,
      Map<String, Object> assetDataMap) throws CSInitializationException
  {
    ...
    assetDeleteRequestDetails.put(IGetAssetDetailsRequestModel.ASSET_SERVER_DETAILS,
        assetServerDetails);
   ...
   * @param assetServerDetails
   * @throws CSInitializationException
   *           fill asset details for authentication
   * @throws PluginException 
   */
  private void fillAssetServerDetails(Map<String, String> assetServerDetails)
      throws CSInitializationException, PluginException
  {
    IJSONContent authenticateSwiftServer = CSDAMServer.instance()
        .getServerInformation();
    assetServerDetails.put("storageUrl",
