...
public class SupplierInstanceDeleteFailedException extends DeleteInstanceFailedException {
  
  private static final long serialVersionUID = 1L;
  
  public SupplierInstanceDeleteFailedException()
  {
    super();
  }
  
  public SupplierInstanceDeleteFailedException(List<IExceptionDetailModel> exceptionDetails,
