...
public class ArticleInstanceDeleteFailedException extends DeleteInstanceFailedException {
  
  private static final long serialVersionUID = 1L;
  
  public ArticleInstanceDeleteFailedException()
  {
    super();
  }
  
  public ArticleInstanceDeleteFailedException(List<IExceptionDetailModel> exceptionDetails,
