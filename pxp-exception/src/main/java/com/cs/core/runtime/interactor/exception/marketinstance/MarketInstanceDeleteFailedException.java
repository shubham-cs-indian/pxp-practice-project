...
public class MarketInstanceDeleteFailedException extends DeleteInstanceFailedException {
  
  private static final long serialVersionUID = 1L;
  
  public MarketInstanceDeleteFailedException()
  {
    super();
  }
  
  public MarketInstanceDeleteFailedException(List<IExceptionDetailModel> exceptionDetails,
