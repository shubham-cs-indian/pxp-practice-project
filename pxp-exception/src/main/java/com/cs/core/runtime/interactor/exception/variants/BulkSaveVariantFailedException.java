...
public class BulkSaveVariantFailedException extends PluginException {
  
  private static final long serialVersionUID = 1L;
  
  public BulkSaveVariantFailedException()
  {
    super();
  }
  
  public BulkSaveVariantFailedException(List<IExceptionDetailModel> exceptionDetails,
