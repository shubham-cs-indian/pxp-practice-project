...
public class BulkSaveUsersFailedException extends PluginException {
  
  private static final long serialVersionUID = 1L;
  
  public BulkSaveUsersFailedException()
  {
    super();
  }
  
  public BulkSaveUsersFailedException(List<IExceptionDetailModel> exceptionDetails,
