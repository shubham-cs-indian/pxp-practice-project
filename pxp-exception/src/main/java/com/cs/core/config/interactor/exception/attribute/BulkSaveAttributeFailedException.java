...
public class BulkSaveAttributeFailedException extends PluginException {
  
  private static final long serialVersionUID = 1L;
  
  public BulkSaveAttributeFailedException()
  {
    super();
  }
  
  public BulkSaveAttributeFailedException(List<IExceptionDetailModel> exceptionDetails,
