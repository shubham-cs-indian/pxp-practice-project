...
public class BulkSaveTimelineEventFailedException extends PluginException {
  
  private static final long serialVersionUID = 1L;
  
  public BulkSaveTimelineEventFailedException()
  {
    super();
  }
  
  public BulkSaveTimelineEventFailedException(List<IExceptionDetailModel> exceptionDetails,
