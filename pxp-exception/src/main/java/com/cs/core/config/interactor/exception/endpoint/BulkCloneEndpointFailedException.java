...
public class BulkCloneEndpointFailedException extends PluginException {
  
  private static final long serialVersionUID = 1L;
  
  public BulkCloneEndpointFailedException(List<IExceptionDetailModel> exceptionDetails,
