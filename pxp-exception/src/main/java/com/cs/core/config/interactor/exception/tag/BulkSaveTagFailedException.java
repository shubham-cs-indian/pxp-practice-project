...
public class BulkSaveTagFailedException extends PluginException {
  
  private static final long serialVersionUID = 1L;
  
  public BulkSaveTagFailedException()
  {
    super();
  }
  
  public BulkSaveTagFailedException(List<IExceptionDetailModel> exceptionDetails,
