...
public class BulkCreateTagValuesFailedException extends PluginException {
  
  private static final long serialVersionUID = 1L;
  
  public BulkCreateTagValuesFailedException()
  {
    super();
  }
  
  public BulkCreateTagValuesFailedException(List<IExceptionDetailModel> exceptionDetails,
